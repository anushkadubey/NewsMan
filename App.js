...
export default class App extends Component {
  ...
  apiKey="d286f6ed01334582a46cc8a9e7121b05";
    ...
    return (
      <div>
        ...
        <Switch>
          ...
          <Route exact path="/general"><News setProgress =  {this.setProgress}  apiKey={this.apiKey} key="general" pageSize={6} country="in" cartegory="general" /></Route>
